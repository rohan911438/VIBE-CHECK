...
.option { display: block; margin: 0.5rem 0; padding: 0.8rem; background: #1e293b; border: 2px solid #334155; border-radius: 8px; cursor: pointer; transition: all 0.3s ease; }
.option:hover { background: #334155; border-color: #60a5fa; }
.option input[type="radio"] { margin-right: 0.8rem; }
.option input[type="radio"]:checked + * { color: #60a5fa; }
.name-input-container { margin: 2rem 0; }
.name-input-container label { display: block; margin-bottom: 0.5rem; color: #94a3b8; }
.name-input-container input { width: 100%; max-width: 300px; padding: 0.8rem; border: 2px solid #334155; border-radius: 8px; background: #1e293b; color: #fff; font-size: 1rem; }
.name-input-container button { margin-top: 1rem; background: #60a5fa; color: #1e293b; border: none; padding: 0.8rem 2rem; border-radius: 25px; cursor: pointer; font-size: 1rem; font-weight: 600; transition: all 0.3s ease; }
.name-input-container button:hover { background: #3b82f6; transform: translateY(-2px); }
`;
